    ...
    <div className="mx-auto w-full max-w-5xl px-6 py-20 sm:px-10">
      <Reveal>
        ...
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/80">
          ...
          Informatique à Ynov Campus Rennes. Passionné par l&rsquo;informatique
          et les nouvelles technologies, je m&rsquo;intéresse particulièrement à
          la manière dont elles évoluent et transforment notre quotidien.
          Curieux et rigoureux, j&rsquo;accorde une grande importance à la
          qualité du travail et à la compréhension des besoins de chaque projet,
          et j&rsquo;aime particulièrement le travail en équipe : échanger des
          idées, apprendre des autres et construire ensemble des solutions
          efficaces.
        </p>
      </Reveal>
      ...
      <Reveal className="mt-16">
        <GlassPanel className="p-6 sm:p-8">
          ...
          <div className="mt-6 flex justify-center">
            <CtaLink href={CV_FILE} download="CVpro-v3.pdf">
              Télécharger mon CV
            </CtaLink>
          </div>
        </GlassPanel>
